...
sitemap_url_dhnet = "https://www.dhnet.be/arc/outboundfeeds/sitemap-news/?outputType=xml"
...
def extract_sitemap_data(sitemap_url_dhnet):
    response = requests.get(sitemap_url_dhnet)
    ...
    for url in urls:
        ...
        sitemap_data_dhnet.append(data)

    return sitemap_data_dhnet
if __name__ == "__main__":
    sitemap_data_dhnet = extract_sitemap_data(sitemap_url_dhnet)
...
for article in sitemap_data_dhnet:
